...
- (void)updateLayers
{
    ...
    self.marker.shadowOffset = CGSizeMake(0, 2);//0,2
    self.marker.shadowRadius = 3.0;
    self.marker.shadowColor = [UIColor whiteColor].CGColor;
    self.marker.shadowOpacity = 0.0;
    self.marker.shouldRasterize = YES;
    self.marker.edgeAntialiasingMask = kCALayerLeftEdge | kCALayerRightEdge | kCALayerBottomEdge | kCALayerTopEdge;
    self.marker.masksToBounds = YES;
